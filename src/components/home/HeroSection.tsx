  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        >
          <button className="w-60 transform rounded-lg bg-black px-6 py-2 font-medium dark:text-white text-black transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-white text-black dark:hover:bg-gray-200">
